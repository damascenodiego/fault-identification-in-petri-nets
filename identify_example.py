...
s.add(And(l1 >= 0,l2 >= 1,l3 >= 1,l4 >= 1,)) # l>=M (To check...)
...
s.add(
	Exists([l1],
		And(mu_p1 +  ((t1_p1-p1_t1)*s1_t1 + (t2_p1-p1_t2)*s1_t2 + (t3_p1-p1_t3)*s1_t3) + l1 * (f_p1 - p1_f) >= p1_t3, 
...
s.add(
	Exists([l2],
		And(mu_p1 +  ((t1_p1-p1_t1)*s2_t1 + (t2_p1-p1_t2)*s2_t2 + (t3_p1-p1_t3)*s2_t3) + l2 * (f_p1 - p1_f) >= p1_t1,
...
s.add(
	Exists([l3],
		And(mu_p1 +  ((t1_p1-p1_t1)*s3_t1 + (t2_p1-p1_t2)*s3_t2 + (t3_p1-p1_t3)*s3_t3) + l3 * (f_p1 - p1_f) >= p1_t2,
...
s.add(
	Exists([l4],
		And(mu_p1 +  ((t1_p1-p1_t1)*s4_t1 + (t2_p1-p1_t2)*s4_t2 + (t3_p1-p1_t3)*s4_t3) + l4 * (f_p1 - p1_f) >= p1_t1,
