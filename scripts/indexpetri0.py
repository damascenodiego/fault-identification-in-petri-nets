...
s.add(
   ForAll([l4],
      And( Implies(l4 >= 0, 
      Or(
         And(l4 >= 0,  mu_p1 + (t1_p1-p1_t1)*s4_t1 + (t2_p1-p1_t2)*s4_t2 + (t3_p1-p1_t3)*s4_t3 + l4 * (f_p1 - p1_f) < p1_t2),
         And(l4 >= 0,  mu_p2 + (t1_p2-p2_t1)*s4_t1 + (t2_p2-p2_t2)*s4_t2 + (t3_p2-p2_t3)*s4_t3 + l4 * (f_p2 - p2_f) < p2_t2),
         And(l4 >= 0,  mu_p3 + (t1_p3-p3_t1)*s4_t1 + (t2_p3-p3_t2)*s4_t2 + (t3_p3-p3_t3)*s4_t3 + l4 * (f_p3 - p3_f) < p3_t2),
      )
      ))
   )
)
...
s.add(
   ForAll([l5],
      And( Implies(l5 >= 1, 
      Or(
         And(l5 >= 1,  mu_p1 + (t1_p1-p1_t1)*s5_t1 + (t2_p1-p1_t2)*s5_t2 + (t3_p1-p1_t3)*s5_t3 + l5 * (f_p1 - p1_f) < p1_t1),
         And(l5 >= 1,  mu_p2 + (t1_p2-p2_t1)*s5_t1 + (t2_p2-p2_t2)*s5_t2 + (t3_p2-p2_t3)*s5_t3 + l5 * (f_p2 - p2_f) < p2_t1),
         And(l5 >= 1,  mu_p3 + (t1_p3-p3_t1)*s5_t1 + (t2_p3-p3_t2)*s5_t2 + (t3_p3-p3_t3)*s5_t3 + l5 * (f_p3 - p3_f) < p3_t1),
      )
      ))
   )
)
...
s.add(
   ForAll([l6],
      And( Implies(l6 >= 1, 
      Or(
         And(l6 >= 1,  mu_p1 + (t1_p1-p1_t1)*s6_t1 + (t2_p1-p1_t2)*s6_t2 + (t3_p1-p1_t3)*s6_t3 + l6 * (f_p1 - p1_f) < p1_t3),
         And(l6 >= 1,  mu_p2 + (t1_p2-p2_t1)*s6_t1 + (t2_p2-p2_t2)*s6_t2 + (t3_p2-p2_t3)*s6_t3 + l6 * (f_p2 - p2_f) < p2_t3),
         And(l6 >= 1,  mu_p3 + (t1_p3-p3_t1)*s6_t1 + (t2_p3-p3_t2)*s6_t2 + (t3_p3-p3_t3)*s6_t3 + l6 * (f_p3 - p3_f) < p3_t3),
      )
      ))
   )
)
...
s.add(
   ForAll([l7],
      ...
      Or(
         ...
         And(l7 >= 0,  mu_p3 + (t1_p3-p3_t1)*s7_t1 + (t2_p3-p3_t2)*s7_t2 + (t3_p3-p3_t3)*s7_t3 + l7 * (f_p3 - p3_f) < p3_t1),
      )
      ))
   )
)
...
s.add(
   ForAll([l8],
      ...
      Or(
         ...
         And(l8 >= 0,  mu_p3 + (t1_p3-p3_t1)*s8_t1 + (t2_p3-p3_t2)*s8_t2 + (t3_p3-p3_t3)*s8_t3 + l8 * (f_p3 - p3_f) < p3_t2),
      )
      ))
   )
)
...
s.add(
   ForAll([l9],
      And( Implies(l9 >= 0, 
      Or(
         And(l9 >= 0,  mu_p1 + (t1_p1-p1_t1)*s9_t1 + (t2_p1-p1_t2)*s9_t2 + (t3_p1-p1_t3)*s9_t3 + l9 * (f_p1 - p1_f) < p1_t3),
         And(l9 >= 0,  mu_p2 + (t1_p2-p2_t1)*s9_t1 + (t2_p2-p2_t2)*s9_t2 + (t3_p2-p2_t3)*s9_t3 + l9 * (f_p2 - p2_f) < p2_t3),
         And(l9 >= 0,  mu_p3 + (t1_p3-p3_t1)*s9_t1 + (t2_p3-p3_t2)*s9_t2 + (t3_p3-p3_t3)*s9_t3 + l9 * (f_p3 - p3_f) < p3_t3),
      )
      ))
   )
)

# Sequence 10: f,t1,t2,t2
s10_t1, s10_t2, s10_t3 = 1, 1, 0
s.add(
   ForAll([l10],
      And( Implies(l10 >= 1, 
      Or(
         And(l10 >= 1,  mu_p1 + (t1_p1-p1_t1)*s10_t1 + (t2_p1-p1_t2)*s10_t2 + (t3_p1-p1_t3)*s10_t3 + l10 * (f_p1 - p1_f) < p1_t2),
         And(l10 >= 1,  mu_p2 + (t1_p2-p2_t1)*s10_t1 + (t2_p2-p2_t2)*s10_t2 + (t3_p2-p2_t3)*s10_t3 + l10 * (f_p2 - p2_f) < p2_t2),
         And(l10 >= 1,  mu_p3 + (t1_p3-p3_t1)*s10_t1 + (t2_p3-p3_t2)*s10_t2 + (t3_p3-p3_t3)*s10_t3 + l10 * (f_p3 - p3_f) < p3_t2),
      )
      ))
   )
)
...
s.add(
   ForAll([l11],
      And( Implies(l11 >= 1, 
      Or(
         And(l11 >= 1,  mu_p1 + (t1_p1-p1_t1)*s11_t1 + (t2_p1-p1_t2)*s11_t2 + (t3_p1-p1_t3)*s11_t3 + l11 * (f_p1 - p1_f) < p1_t3),
         And(l11 >= 1,  mu_p2 + (t1_p2-p2_t1)*s11_t1 + (t2_p2-p2_t2)*s11_t2 + (t3_p2-p2_t3)*s11_t3 + l11 * (f_p2 - p2_f) < p2_t3),
         And(l11 >= 1,  mu_p3 + (t1_p3-p3_t1)*s11_t1 + (t2_p3-p3_t2)*s11_t2 + (t3_p3-p3_t3)*s11_t3 + l11 * (f_p3 - p3_f) < p3_t3),
      )
      ))
   )
)
