...
s.add(
   Exists([l3],
      ...
      And(l3 >= 0, 
         ...
         mu_p3 + (t1_p3-p3_t1)*s3_t1 + (t2_p3-p3_t2)*s3_t2 + (t3_p3-p3_t3)*s3_t3 + l3 * (f_p3 - p3_f) >= p3_t3,
      )
      ))
   )
)
...
s.add(
   Exists([l5],
      ...
      And(l5 >= 0, 
         ...
         mu_p3 + (t1_p3-p3_t1)*s5_t1 + (t2_p3-p3_t2)*s5_t2 + (t3_p3-p3_t3)*s5_t3 + l5 * (f_p3 - p3_f) >= p3_t3,
      )
      ))
   )
)
...
# Sequence 11: t3,t3,t1
s11_t1, s11_t2, s11_t3 = 0, 0, 2
s.add(
   Exists([l11],
      And( Implies(l11 >= 0, 
      And(l11 >= 0, 
...
s.add(
   ForAll([l13],
      And( Implies(l13 >= 0, 
      Or(
         And(l13 >= 0,  mu_p1 + (t1_p1-p1_t1)*s13_t1 + (t2_p1-p1_t2)*s13_t2 + (t3_p1-p1_t3)*s13_t3 + l13 * (f_p1 - p1_f) < p1_t2),
         And(l13 >= 0,  mu_p2 + (t1_p2-p2_t1)*s13_t1 + (t2_p2-p2_t2)*s13_t2 + (t3_p2-p2_t3)*s13_t3 + l13 * (f_p2 - p2_f) < p2_t2),
         And(l13 >= 0,  mu_p3 + (t1_p3-p3_t1)*s13_t1 + (t2_p3-p3_t2)*s13_t2 + (t3_p3-p3_t3)*s13_t3 + l13 * (f_p3 - p3_f) < p3_t2),
      )
      ))
   )
)
...
# Sequence 14: t1,t1
s14_t1, s14_t2, s14_t3 = 1, 0, 0
s.add(
   ForAll([l14],
      And( Implies(l14 >= 0, 
      Or(
         And(l14 >= 0,  mu_p1 + (t1_p1-p1_t1)*s14_t1 + (t2_p1-p1_t2)*s14_t2 + (t3_p1-p1_t3)*s14_t3 + l14 * (f_p1 - p1_f) < p1_t1),
         And(l14 >= 0,  mu_p2 + (t1_p2-p2_t1)*s14_t1 + (t2_p2-p2_t2)*s14_t2 + (t3_p2-p2_t3)*s14_t3 + l14 * (f_p2 - p2_f) < p2_t1),
         And(l14 >= 0,  mu_p3 + (t1_p3-p3_t1)*s14_t1 + (t2_p3-p3_t2)*s14_t2 + (t3_p3-p3_t3)*s14_t3 + l14 * (f_p3 - p3_f) < p3_t1),
      )
      ))
   )
)
...
s.add(
   ForAll([l16],
      And( Implies(l16 >= 0, 
      Or(
         And(l16 >= 0,  mu_p1 + (t1_p1-p1_t1)*s16_t1 + (t2_p1-p1_t2)*s16_t2 + (t3_p1-p1_t3)*s16_t3 + l16 * (f_p1 - p1_f) < p1_t1),
         And(l16 >= 0,  mu_p2 + (t1_p2-p2_t1)*s16_t1 + (t2_p2-p2_t2)*s16_t2 + (t3_p2-p2_t3)*s16_t3 + l16 * (f_p2 - p2_f) < p2_t1),
         And(l16 >= 0,  mu_p3 + (t1_p3-p3_t1)*s16_t1 + (t2_p3-p3_t2)*s16_t2 + (t3_p3-p3_t3)*s16_t3 + l16 * (f_p3 - p3_f) < p3_t1),
      )
      ))
   )
)
...
s.add(
   ForAll([l17],
      And( Implies(l17 >= 0, 
      Or(
         And(l17 >= 0,  mu_p1 + (t1_p1-p1_t1)*s17_t1 + (t2_p1-p1_t2)*s17_t2 + (t3_p1-p1_t3)*s17_t3 + l17 * (f_p1 - p1_f) < p1_t2),
         And(l17 >= 0,  mu_p2 + (t1_p2-p2_t1)*s17_t1 + (t2_p2-p2_t2)*s17_t2 + (t3_p2-p2_t3)*s17_t3 + l17 * (f_p2 - p2_f) < p2_t2),
         And(l17 >= 0,  mu_p3 + (t1_p3-p3_t1)*s17_t1 + (t2_p3-p3_t2)*s17_t2 + (t3_p3-p3_t3)*s17_t3 + l17 * (f_p3 - p3_f) < p3_t2),
      )
      ))
   )
)
